...
void displayTextContent(void)
{
	...
	display_string(380,560,"Banglore institute of technology",1);
	display_string(350,520,"Computer Graphics Visualization lab",1);
...
int main(int argc, char** argv)
{
	...
	glutCreateWindow("miniproject 17cs042"); /* Open a window with a title. */
